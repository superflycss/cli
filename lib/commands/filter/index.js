...
exports.bmfc = () => {
    ...
    if (postcss_plugins.length > 0) {
        log('info', 'Deleting target/main/css/**/*filtering.css content.');
        del.sync(MAIN_FILTERED_CSS);
...
exports.btfc = () => {
    ...
    if (postcss_plugins.length > 0) {
        log('info', 'Deleting target/test/css/**/*filtered.css content.');
        del.sync(TEST_FILTERED_CSS);
