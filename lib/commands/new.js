    ...
    cli.
        ...
        action((name) => {            
            if (cli.type == PROJECT_TYPE_COMPONENT) {
                ...
                fs.writeFileSync(`./${name}/package.json`, require('../generators/package-json')(name));
                fs.writeFileSync(`./${name}/.gitignore`, require('../generators/gitignore'));
                fs.writeFileSync(`./${name}/${PLI.src.test.html}/index.html`, require('../generators/test-index-html')(name));
                fs.writeFileSync(`./${name}/${PLI.src.test.css}/index.css`, require('../generators/test-index-css')());
                fs.writeFileSync(`./${name}/${PLI.src.main.css}/index.css`, require('../generators/main-index-css'));
            }
