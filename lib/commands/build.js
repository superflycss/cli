...
function runBuild() {
  return new Promise(resolve => {
    return Promise.all([bmmd(), btmd()]).then(() => {
      ...
      Promise.all([
        copySrcTestSVG(PLI.target.test.svg),
        bmh(),
        bmc(),
        bms(),
        btc(),
...
module.exports.build = async cli => {
  ...
  cli
    ...
    .action(() => {
      bmmd().then(()=>{
        log("info", "Completed build of main md content");
      });
    });
  ...
  cli
    ...
    .action(() => {
      btmd().then(()=>{
        log("info", "Completed build of test md content");
      });
    });
  ...
  cli
    ...
    .action(() => {
      bmc().then(()=>{
        log("info", "Completed build of main css content");
      });
    });
  ...
  cli
    ...
    .action(() => {
      btc().then(()=>{
        log("info", "Completed build of test css content");
      });
    });
  ...
  cli
    ...
    .action(() => {
      bmh().then(() => {
        log("info", "Completed build of main html content");
      });
    });
  ...
  cli
    ...
    .action(() => {
      bth().then(() => {
        log("info", "Completed build of test html content");
      });
    });
  ...
  cli
    ...
    .action(() => {
      bmfc().then(() => {
        log("info", "Completed filtering of main css content");
      });
    });
  ...
  cli
    ...
    .action(() => {
      btfc().then(() => {
        log("info", "Completed filtering of test css content");
      });
    });
  ...
  cli
    ...
    .action(() => {
      bmmc().then(() => {
        log("info", "Completed minification of test css content");
      });
    });
